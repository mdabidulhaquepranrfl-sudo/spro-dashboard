            ...
            <div className="card-body">
              ...
              <div className="app-brand justify-content-center mb-6">
                <Link href="/login" className="app-brand-link gap-2">
                  <SneatLogo />
                  <span className="app-brand-text demo text-heading fw-bold">SPRO</span>
                </Link>
              </div>
              {/* /Logo */}
              ...
              <form id="formAuthentication" className="mb-6" action="/home" method="get">
                ...
                <div className="form-password-toggle mb-0">
                  ...
                  <div className="input-group input-group-merge">
                    <input
                      ...
                      name="password"
                      placeholder="············"
                      aria-describedby="reg-password"
                    />
                    <span className="input-group-text cursor-pointer">
                      <i className="icon-base bx bx-hide" />
                    </span>
                  </div>
                </div>
